...
public class DateAndTime_02_Test {
	...
	public void test_localDate_format() {
		...
		DateTimeFormatter monFormatter = DateTimeFormatter.ofPattern("dd - MM - yyyy");
		String result = localDate.format(monFormatter);
	...
	public void test_localDate_format_with_hour() {
		...
		// 00:00:00"
		DateTimeFormatter monFormatter = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss");
		localDate.format(monFormatter);
	}
